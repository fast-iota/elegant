...
PARAMETER ckicker_param[N_CKICKER_PARAMS] = {
  ...
  {"ANGLE_RAD", "MRAD", IS_DOUBLE, 0, (long)((char *)&cKicker_example.angle_rad), NULL, 0.0, 0, "Angle*gamma, in mrad, of pickup radiation."},
  {"RAD_FUDGE", "", IS_DOUBLE, 0, (long)((char *)&cKicker_example.rad_fudge), NULL, 1.0, 0, "Fudge factor to apply to the wavelength when calcuation the radiation field in transverse mode."},
