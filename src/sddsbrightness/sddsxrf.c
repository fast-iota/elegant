 ...
 for (i_arg = 1; i_arg < argc; i_arg++) {
   if (s_arg[i_arg].arg_type == OPTION) {
     ...
     case SET_TARGET:
       ...
       if (material != NULL) {
         if (verbose > 3)
           printf(" User provides target material name. \n");
         ...
         if (verbose > 3)
           printf(" User provides target formula. \n");
         strcpy(matrixFormula, formula);
     ...
     case SET_DETECTOR:
       ...
       if (upstream)
         detectDownstream = 0;
       if (detectThetaZ < 0.0)
         detectThetaZ = fabs(detectThetaZ);
...
int getLineID(char *name) {
  ...
  if (strcmp(name, "KA") == 0) {
    ...
    value = LB_LINE;
    /* Single lines */
  } else if (strcmp(name, "KA1") == 0) {
    value = KA1_LINE;
  } else if (strcmp(name, "KA2") == 0) {
    value = KA2_LINE;
  } else if (strcmp(name, "KB1") == 0) {
    value = KB1_LINE;
  } else if (strcmp(name, "KB2") == 0) {
    value = KB2_LINE;
  } else if (strcmp(name, "KB3") == 0) {
    value = KB3_LINE;
  } else if (strcmp(name, "KB4") == 0) {
    value = KB4_LINE;
  } else if (strcmp(name, "KB5") == 0) {
    value = KB5_LINE;
  } else if (strcmp(name, "LA1") == 0) {
    value = LA1_LINE;
  } else if (strcmp(name, "LA2") == 0) {
    value = LA2_LINE;
  } else if (strcmp(name, "LB1") == 0) {
    value = LB1_LINE;
  } else if (strcmp(name, "LB2") == 0) {
    value = LB2_LINE;
  } else if (strcmp(name, "LB3") == 0) {
    value = LB3_LINE;
  } else if (strcmp(name, "LB4") == 0) {
    value = LB4_LINE;
  } else if (strcmp(name, "LB5") == 0) {
    value = LB5_LINE;
  } else if (strcmp(name, "LB6") == 0) {
    value = LB6_LINE;
  } else if (strcmp(name, "LB7") == 0) {
    value = LB7_LINE;
  } else if (strcmp(name, "LB9") == 0) {
    value = LB9_LINE;
  } else if (strcmp(name, "LB10") == 0) {
    value = LB10_LINE;
  } else if (strcmp(name, "LB15") == 0) {
    value = LB15_LINE;
  } else if (strcmp(name, "LB17") == 0) {
    value = LB17_LINE;
  } else if (strcmp(name, "LG1") == 0) {
    value = LG1_LINE;
  } else if (strcmp(name, "LG2") == 0) {
    value = LG2_LINE;
  } else if (strcmp(name, "LG3") == 0) {
    value = LG3_LINE;
  } else if (strcmp(name, "LG4") == 0) {
    value = LG4_LINE;
  } else if (strcmp(name, "LG5") == 0) {
    value = LG5_LINE;
  } else if (strcmp(name, "LG6") == 0) {
    value = LG6_LINE;
  } else if (strcmp(name, "LG8") == 0) {
    value = LG8_LINE;
    ...
    value = LU_LINE;
  } else if (strcmp(name, "LV") == 0) {
    value = LV_LINE;
  } else if (strcmp(name, "MA1") == 0) {
    value = MA1_LINE;
  } else if (strcmp(name, "MA2") == 0) {
    value = MA2_LINE;
  } else if (strcmp(name, "MB") == 0) {
    value = MB_LINE;
  } else if (strcmp(name, "MG") == 0) {
    value = MG_LINE;
  } else if (strcmp(name, "KL1") == 0) {
    value = KL1_LINE;
  } else if (strcmp(name, "KL2") == 0) {
    value = KL2_LINE;
  } else if (strcmp(name, "KL3") == 0) {
    value = KL3_LINE;
  } else if (strcmp(name, "KM1") == 0) {
    value = KM1_LINE;
  } else if (strcmp(name, "KM2") == 0) {
    value = KM2_LINE;
  } else if (strcmp(name, "KM3") == 0) {
    value = KM3_LINE;
  } else if (strcmp(name, "KM4") == 0) {
    value = KM4_LINE;
  } else if (strcmp(name, "KM5") == 0) {
    value = KM5_LINE;
  } else if (strcmp(name, "KN1") == 0) {
    value = KN1_LINE;
  } else if (strcmp(name, "KN2") == 0) {
    value = KN2_LINE;
  } else if (strcmp(name, "KN3") == 0) {
    value = KN3_LINE;
  } else if (strcmp(name, "KN4") == 0) {
    value = KN4_LINE;
  } else if (strcmp(name, "KN5") == 0) {
    value = KN5_LINE;
  } else if (strcmp(name, "KN6") == 0) {
    value = KN6_LINE;
  } else if (strcmp(name, "KN7") == 0) {
    value = KN7_LINE;
  } else if (strcmp(name, "KO1") == 0) {
    value = KO1_LINE;
  } else if (strcmp(name, "KO2") == 0) {
    value = KO2_LINE;
  } else if (strcmp(name, "KO3") == 0) {
    value = KO3_LINE;
  } else if (strcmp(name, "KO4") == 0) {
    value = KO4_LINE;
  } else if (strcmp(name, "KO5") == 0) {
    value = KO5_LINE;
  } else if (strcmp(name, "KO6") == 0) {
    value = KO6_LINE;
  } else if (strcmp(name, "KO7") == 0) {
    value = KO7_LINE;
    ...
    value = KP5_LINE;
  } else if (strcmp(name, "L1L2") == 0) {
    value = L1L2_LINE;
  } else if (strcmp(name, "L1L3") == 0) {
    value = L1L3_LINE;
  } else if (strcmp(name, "L1M1") == 0) {
    value = L1M1_LINE;
  } else if (strcmp(name, "L1M2") == 0) {
    value = L1M2_LINE;
  } else if (strcmp(name, "L1M3") == 0) {
    value = L1M3_LINE;
  } else if (strcmp(name, "L1M4") == 0) {
    value = L1M4_LINE;
  } else if (strcmp(name, "L1M5") == 0) {
    value = L1M5_LINE;
  } else if (strcmp(name, "L1N1") == 0) {
    value = L1N1_LINE;
  } else if (strcmp(name, "L1N2") == 0) {
    value = L1N2_LINE;
  } else if (strcmp(name, "L1N3") == 0) {
    value = L1N3_LINE;
  } else if (strcmp(name, "L1N4") == 0) {
    value = L1N4_LINE;
  } else if (strcmp(name, "L1N5") == 0) {
    value = L1N5_LINE;
  } else if (strcmp(name, "L1N6") == 0) {
    value = L1N6_LINE;
  } else if (strcmp(name, "L1N7") == 0) {
    value = L1N7_LINE;
  } else if (strcmp(name, "L1N67") == 0) {
    value = L1N67_LINE;
  } else if (strcmp(name, "L1O1") == 0) {
    value = L1O1_LINE;
  } else if (strcmp(name, "L1O2") == 0) {
    value = L1O2_LINE;
  } else if (strcmp(name, "L1O3") == 0) {
    value = L1O3_LINE;
  } else if (strcmp(name, "L1O4") == 0) {
    value = L1O4_LINE;
  } else if (strcmp(name, "L1O45") == 0) {
    value = L1O45_LINE;
  } else if (strcmp(name, "L1O5") == 0) {
    value = L1O5_LINE;
  } else if (strcmp(name, "L1O6") == 0) {
    value = L1O6_LINE;
  } else if (strcmp(name, "L1O7") == 0) {
    value = L1O7_LINE;
  } else if (strcmp(name, "L1P1") == 0) {
    value = L1P1_LINE;
  } else if (strcmp(name, "L1P2") == 0) {
    value = L1P2_LINE;
  } else if (strcmp(name, "L1P23") == 0) {
    value = L1P23_LINE;
  } else if (strcmp(name, "L1P3") == 0) {
    value = L1P3_LINE;
  } else if (strcmp(name, "L1P4") == 0) {
    value = L1P4_LINE;
  } else if (strcmp(name, "L1P5") == 0) {
    value = L1P5_LINE;
  } else if (strcmp(name, "L2L3") == 0) {
    value = L2L3_LINE;
  } else if (strcmp(name, "L2M1") == 0) {
    value = L2M1_LINE;
  } else if (strcmp(name, "L2M2") == 0) {
    value = L2M2_LINE;
  } else if (strcmp(name, "L2M3") == 0) {
    value = L2M3_LINE;
  } else if (strcmp(name, "L2M4") == 0) {
    value = L2M4_LINE;
  } else if (strcmp(name, "L2M5") == 0) {
    value = L2M5_LINE;
  } else if (strcmp(name, "L2N1") == 0) {
    value = L2N1_LINE;
  } else if (strcmp(name, "L2N2") == 0) {
    value = L2N2_LINE;
  } else if (strcmp(name, "L2N3") == 0) {
    value = L2N3_LINE;
  } else if (strcmp(name, "L2N4") == 0) {
    value = L2N4_LINE;
  } else if (strcmp(name, "L2N5") == 0) {
    value = L2N5_LINE;
  } else if (strcmp(name, "L2N6") == 0) {
    value = L2N6_LINE;
  } else if (strcmp(name, "L2N7") == 0) {
    value = L2N7_LINE;
  } else if (strcmp(name, "L2O1") == 0) {
    value = L2O1_LINE;
  } else if (strcmp(name, "L2O2") == 0) {
    value = L2O2_LINE;
  } else if (strcmp(name, "L2O3") == 0) {
    value = L2O3_LINE;
  } else if (strcmp(name, "L2O4") == 0) {
    value = L2O4_LINE;
  } else if (strcmp(name, "L2O5") == 0) {
    value = L2O5_LINE;
  } else if (strcmp(name, "L2O6") == 0) {
    value = L2O6_LINE;
  } else if (strcmp(name, "L2O7") == 0) {
    value = L2O7_LINE;
  } else if (strcmp(name, "L2P1") == 0) {
    value = L2P1_LINE;
  } else if (strcmp(name, "L2P2") == 0) {
    value = L2P2_LINE;
  } else if (strcmp(name, "L2P23") == 0) {
    value = L2P23_LINE;
  } else if (strcmp(name, "L2P3") == 0) {
    value = L2P3_LINE;
  } else if (strcmp(name, "L2P4") == 0) {
    value = L2P4_LINE;
  } else if (strcmp(name, "L2P5") == 0) {
    value = L2P5_LINE;
  } else if (strcmp(name, "L2Q1") == 0) {
    value = L2Q1_LINE;
  } else if (strcmp(name, "L3M1") == 0) {
    value = L3M1_LINE;
  } else if (strcmp(name, "L3M2") == 0) {
    value = L3M2_LINE;
  } else if (strcmp(name, "L3M3") == 0) {
    value = L3M3_LINE;
  } else if (strcmp(name, "L3M4") == 0) {
    value = L3M4_LINE;
  } else if (strcmp(name, "L3M5") == 0) {
    value = L3M5_LINE;
  } else if (strcmp(name, "L3N1") == 0) {
    value = L3N1_LINE;
  } else if (strcmp(name, "L3N2") == 0) {
    value = L3N2_LINE;
  } else if (strcmp(name, "L3N3") == 0) {
    value = L3N3_LINE;
  } else if (strcmp(name, "L3N4") == 0) {
    value = L3N4_LINE;
  } else if (strcmp(name, "L3N5") == 0) {
    value = L3N5_LINE;
  } else if (strcmp(name, "L3N6") == 0) {
    value = L3N6_LINE;
  } else if (strcmp(name, "L3N7") == 0) {
    value = L3N7_LINE;
  } else if (strcmp(name, "L3O1") == 0) {
    value = L3O1_LINE;
  } else if (strcmp(name, "L3O2") == 0) {
    value = L3O2_LINE;
  } else if (strcmp(name, "L3O3") == 0) {
    value = L3O3_LINE;
  } else if (strcmp(name, "L3O4") == 0) {
    value = L3O4_LINE;
  } else if (strcmp(name, "L3O45") == 0) {
    value = L3O45_LINE;
  } else if (strcmp(name, "L3O5") == 0) {
    value = L3O5_LINE;
  } else if (strcmp(name, "L3O6") == 0) {
    value = L3O6_LINE;
  } else if (strcmp(name, "L3O7") == 0) {
    value = L3O7_LINE;
  } else if (strcmp(name, "L3P1") == 0) {
    value = L3P1_LINE;
  } else if (strcmp(name, "L3P2") == 0) {
    value = L3P2_LINE;
  } else if (strcmp(name, "L3P23") == 0) {
    value = L3P23_LINE;
  } else if (strcmp(name, "L3P3") == 0) {
    value = L3P3_LINE;
  } else if (strcmp(name, "L3P4") == 0) {
    value = L3P4_LINE;
  } else if (strcmp(name, "L3P45") == 0) {
    value = L3P45_LINE;
  } else if (strcmp(name, "L3P5") == 0) {
    value = L3P5_LINE;
  } else if (strcmp(name, "L3Q1") == 0) {
    value = L3Q1_LINE;
  } else if (strcmp(name, "M1M2") == 0) {
    value = M1M2_LINE;
  } else if (strcmp(name, "M1M3") == 0) {
    value = M1M3_LINE;
  } else if (strcmp(name, "M1M4") == 0) {
    value = M1M4_LINE;
  } else if (strcmp(name, "M1M5") == 0) {
    value = M1M5_LINE;
  } else if (strcmp(name, "M1N1") == 0) {
    value = M1N1_LINE;
  } else if (strcmp(name, "M1N2") == 0) {
    value = M1N2_LINE;
  } else if (strcmp(name, "M1N3") == 0) {
    value = M1N3_LINE;
  } else if (strcmp(name, "M1N4") == 0) {
    value = M1N4_LINE;
  } else if (strcmp(name, "M1N5") == 0) {
    value = M1N5_LINE;
  } else if (strcmp(name, "M1N6") == 0) {
    value = M1N6_LINE;
  } else if (strcmp(name, "M1N7") == 0) {
    value = M1N7_LINE;
  } else if (strcmp(name, "M1O1") == 0) {
    value = M1O1_LINE;
  } else if (strcmp(name, "M1O2") == 0) {
    value = M1O2_LINE;
  } else if (strcmp(name, "M1O3") == 0) {
    value = M1O3_LINE;
  } else if (strcmp(name, "M1O4") == 0) {
    value = M1O4_LINE;
  } else if (strcmp(name, "M1O5") == 0) {
    value = M1O5_LINE;
  } else if (strcmp(name, "M1O6") == 0) {
    value = M1O6_LINE;
  } else if (strcmp(name, "M1O7") == 0) {
    value = M1O7_LINE;
  } else if (strcmp(name, "M1P1") == 0) {
    value = M1P1_LINE;
  } else if (strcmp(name, "M1P2") == 0) {
    value = M1P2_LINE;
  } else if (strcmp(name, "M1P3") == 0) {
    value = M1P3_LINE;
  } else if (strcmp(name, "M1P4") == 0) {
    value = M1P4_LINE;
  } else if (strcmp(name, "M1P5") == 0) {
    value = M1P5_LINE;
  } else if (strcmp(name, "M2M3") == 0) {
    value = M2M3_LINE;
  } else if (strcmp(name, "M2M4") == 0) {
    value = M2M4_LINE;
  } else if (strcmp(name, "M2M5") == 0) {
    value = M2M5_LINE;
  } else if (strcmp(name, "M2N1") == 0) {
    value = M2N1_LINE;
  } else if (strcmp(name, "M2N2") == 0) {
    value = M2N2_LINE;
  } else if (strcmp(name, "M2N3") == 0) {
    value = M2N3_LINE;
  } else if (strcmp(name, "M2N4") == 0) {
    value = M2N4_LINE;
  } else if (strcmp(name, "M2N5") == 0) {
    value = M2N5_LINE;
  } else if (strcmp(name, "M2N6") == 0) {
    value = M2N6_LINE;
  } else if (strcmp(name, "M2N7") == 0) {
    value = M2N7_LINE;
  } else if (strcmp(name, "M2O1") == 0) {
    value = M2O1_LINE;
  } else if (strcmp(name, "M2O2") == 0) {
    value = M2O2_LINE;
  } else if (strcmp(name, "M2O3") == 0) {
    value = M2O3_LINE;
  } else if (strcmp(name, "M2O4") == 0) {
    value = M2O4_LINE;
  } else if (strcmp(name, "M2O5") == 0) {
    value = M2O5_LINE;
  } else if (strcmp(name, "M2O6") == 0) {
    value = M2O6_LINE;
  } else if (strcmp(name, "M2O7") == 0) {
    value = M2O7_LINE;
  } else if (strcmp(name, "M2P1") == 0) {
    value = M2P1_LINE;
  } else if (strcmp(name, "M2P2") == 0) {
    value = M2P2_LINE;
  } else if (strcmp(name, "M2P3") == 0) {
    value = M2P3_LINE;
  } else if (strcmp(name, "M2P4") == 0) {
    value = M2P4_LINE;
  } else if (strcmp(name, "M2P5") == 0) {
    value = M2P5_LINE;
  } else if (strcmp(name, "M3M4") == 0) {
    value = M3M4_LINE;
  } else if (strcmp(name, "M3M5") == 0) {
    value = M3M5_LINE;
  } else if (strcmp(name, "M3N1") == 0) {
    value = M3N1_LINE;
  } else if (strcmp(name, "M3N2") == 0) {
    value = M3N2_LINE;
  } else if (strcmp(name, "M3N3") == 0) {
    value = M3N3_LINE;
  } else if (strcmp(name, "M3N4") == 0) {
    value = M3N4_LINE;
  } else if (strcmp(name, "M3N5") == 0) {
    value = M3N5_LINE;
  } else if (strcmp(name, "M3N6") == 0) {
    value = M3N6_LINE;
  } else if (strcmp(name, "M3N7") == 0) {
    value = M3N7_LINE;
  } else if (strcmp(name, "M3O1") == 0) {
    value = M3O1_LINE;
  } else if (strcmp(name, "M3O2") == 0) {
    value = M3O2_LINE;
  } else if (strcmp(name, "M3O3") == 0) {
    value = M3O3_LINE;
  } else if (strcmp(name, "M3O4") == 0) {
    value = M3O4_LINE;
  } else if (strcmp(name, "M3O5") == 0) {
    value = M3O5_LINE;
  } else if (strcmp(name, "M3O6") == 0) {
    value = M3O6_LINE;
  } else if (strcmp(name, "M3O7") == 0) {
    value = M3O7_LINE;
  } else if (strcmp(name, "M3P1") == 0) {
    value = M3P1_LINE;
  } else if (strcmp(name, "M3P2") == 0) {
    value = M3P2_LINE;
  } else if (strcmp(name, "M3P3") == 0) {
    value = M3P3_LINE;
  } else if (strcmp(name, "M3P4") == 0) {
    value = M3P4_LINE;
  } else if (strcmp(name, "M3P5") == 0) {
    value = M3P5_LINE;
  } else if (strcmp(name, "M3Q1") == 0) {
    value = M3Q1_LINE;
  } else if (strcmp(name, "M4M5") == 0) {
    value = M4M5_LINE;
  } else if (strcmp(name, "M4N1") == 0) {
    value = M4N1_LINE;
  } else if (strcmp(name, "M4N2") == 0) {
    value = M4N2_LINE;
  } else if (strcmp(name, "M4N3") == 0) {
    value = M4N3_LINE;
  } else if (strcmp(name, "M4N4") == 0) {
    value = M4N4_LINE;
  } else if (strcmp(name, "M4N5") == 0) {
    value = M4N5_LINE;
  } else if (strcmp(name, "M4N6") == 0) {
    value = M4N6_LINE;
  } else if (strcmp(name, "M4N7") == 0) {
    value = M4N7_LINE;
  } else if (strcmp(name, "M4O1") == 0) {
    value = M4O1_LINE;
  } else if (strcmp(name, "M4O2") == 0) {
    value = M4O2_LINE;
  } else if (strcmp(name, "M4O3") == 0) {
    value = M4O3_LINE;
  } else if (strcmp(name, "M4O4") == 0) {
    value = M4O4_LINE;
  } else if (strcmp(name, "M4O5") == 0) {
    value = M4O5_LINE;
  } else if (strcmp(name, "M4O6") == 0) {
    value = M4O6_LINE;
  } else if (strcmp(name, "M4O7") == 0) {
    value = M4O7_LINE;
  } else if (strcmp(name, "M4P1") == 0) {
    value = M4P1_LINE;
  } else if (strcmp(name, "M4P2") == 0) {
    value = M4P2_LINE;
  } else if (strcmp(name, "M4P3") == 0) {
    value = M4P3_LINE;
  } else if (strcmp(name, "M4P4") == 0) {
    value = M4P4_LINE;
  } else if (strcmp(name, "M4P5") == 0) {
    value = M4P5_LINE;
  } else if (strcmp(name, "M5N1") == 0) {
    value = M5N1_LINE;
  } else if (strcmp(name, "M5N2") == 0) {
    value = M5N2_LINE;
  } else if (strcmp(name, "M5N3") == 0) {
    value = M5N3_LINE;
  } else if (strcmp(name, "M5N4") == 0) {
    value = M5N4_LINE;
  } else if (strcmp(name, "M5N5") == 0) {
    value = M5N5_LINE;
  } else if (strcmp(name, "M5N6") == 0) {
    value = M5N6_LINE;
  } else if (strcmp(name, "M5N7") == 0) {
    value = M5N7_LINE;
  } else if (strcmp(name, "M5O1") == 0) {
    value = M5O1_LINE;
  } else if (strcmp(name, "M5O2") == 0) {
    value = M5O2_LINE;
  } else if (strcmp(name, "M5O3") == 0) {
    value = M5O3_LINE;
  } else if (strcmp(name, "M5O4") == 0) {
    value = M5O4_LINE;
  } else if (strcmp(name, "M5O5") == 0) {
    value = M5O5_LINE;
  } else if (strcmp(name, "M5O6") == 0) {
    value = M5O6_LINE;
  } else if (strcmp(name, "M5O7") == 0) {
    value = M5O7_LINE;
  } else if (strcmp(name, "M5P1") == 0) {
    value = M5P1_LINE;
  } else if (strcmp(name, "M5P2") == 0) {
    value = M5P2_LINE;
  } else if (strcmp(name, "M5P3") == 0) {
    value = M5P3_LINE;
  } else if (strcmp(name, "M5P4") == 0) {
    value = M5P4_LINE;
  } else if (strcmp(name, "M5P5") == 0) {
    value = M5P5_LINE;
  } else if (strcmp(name, "N1N2") == 0) {
    value = N1N2_LINE;
  } else if (strcmp(name, "N1N3") == 0) {
    value = N1N3_LINE;
  } else if (strcmp(name, "N1N4") == 0) {
    value = N1N4_LINE;
  } else if (strcmp(name, "N1N5") == 0) {
    value = N1N5_LINE;
  } else if (strcmp(name, "N1N6") == 0) {
    value = N1N6_LINE;
  } else if (strcmp(name, "N1N7") == 0) {
    value = N1N7_LINE;
  } else if (strcmp(name, "N1O1") == 0) {
    value = N1O1_LINE;
  } else if (strcmp(name, "N1O2") == 0) {
    value = N1O2_LINE;
  } else if (strcmp(name, "N1O3") == 0) {
    value = N1O3_LINE;
  } else if (strcmp(name, "N1O4") == 0) {
    value = N1O4_LINE;
  } else if (strcmp(name, "N1O5") == 0) {
    value = N1O5_LINE;
  } else if (strcmp(name, "N1O6") == 0) {
    value = N1O6_LINE;
  } else if (strcmp(name, "N1O7") == 0) {
    value = N1O7_LINE;
  } else if (strcmp(name, "N1P1") == 0) {
    value = N1P1_LINE;
  } else if (strcmp(name, "N1P2") == 0) {
    value = N1P2_LINE;
  } else if (strcmp(name, "N1P3") == 0) {
    value = N1P3_LINE;
  } else if (strcmp(name, "N1P4") == 0) {
    value = N1P4_LINE;
  } else if (strcmp(name, "N1P5") == 0) {
    value = N1P5_LINE;
  } else if (strcmp(name, "N2N3") == 0) {
    value = N2N3_LINE;
  } else if (strcmp(name, "N2N4") == 0) {
    value = N2N4_LINE;
  } else if (strcmp(name, "N2N5") == 0) {
    value = N2N5_LINE;
  } else if (strcmp(name, "N2N6") == 0) {
    value = N2N6_LINE;
  } else if (strcmp(name, "N2N7") == 0) {
    value = N2N7_LINE;
  } else if (strcmp(name, "N2O1") == 0) {
    value = N2O1_LINE;
  } else if (strcmp(name, "N2O2") == 0) {
    value = N2O2_LINE;
  } else if (strcmp(name, "N2O3") == 0) {
    value = N2O3_LINE;
  } else if (strcmp(name, "N2O4") == 0) {
    value = N2O4_LINE;
  } else if (strcmp(name, "N2O5") == 0) {
    value = N2O5_LINE;
  } else if (strcmp(name, "N2O6") == 0) {
    value = N2O6_LINE;
  } else if (strcmp(name, "N2O7") == 0) {
    value = N2O7_LINE;
  } else if (strcmp(name, "N2P1") == 0) {
    value = N2P1_LINE;
  } else if (strcmp(name, "N2P2") == 0) {
    value = N2P2_LINE;
  } else if (strcmp(name, "N2P3") == 0) {
    value = N2P3_LINE;
  } else if (strcmp(name, "N2P4") == 0) {
    value = N2P4_LINE;
  } else if (strcmp(name, "N2P5") == 0) {
    value = N2P5_LINE;
  } else if (strcmp(name, "N3N4") == 0) {
    value = N3N4_LINE;
  } else if (strcmp(name, "N3N5") == 0) {
    value = N3N5_LINE;
  } else if (strcmp(name, "N3N6") == 0) {
    value = N3N6_LINE;
  } else if (strcmp(name, "N3N7") == 0) {
    value = N3N7_LINE;
  } else if (strcmp(name, "N3O1") == 0) {
    value = N3O1_LINE;
  } else if (strcmp(name, "N3O2") == 0) {
    value = N3O2_LINE;
  } else if (strcmp(name, "N3O3") == 0) {
    value = N3O3_LINE;
  } else if (strcmp(name, "N3O4") == 0) {
    value = N3O4_LINE;
  } else if (strcmp(name, "N3O5") == 0) {
    value = N3O5_LINE;
  } else if (strcmp(name, "N3O6") == 0) {
    value = N3O6_LINE;
  } else if (strcmp(name, "N3O7") == 0) {
    value = N3O7_LINE;
  } else if (strcmp(name, "N3P1") == 0) {
    value = N3P1_LINE;
  } else if (strcmp(name, "N3P2") == 0) {
    value = N3P2_LINE;
  } else if (strcmp(name, "N3P3") == 0) {
    value = N3P3_LINE;
  } else if (strcmp(name, "N3P4") == 0) {
    value = N3P4_LINE;
  } else if (strcmp(name, "N3P5") == 0) {
    value = N3P5_LINE;
  } else if (strcmp(name, "N4N5") == 0) {
    value = N4N5_LINE;
  } else if (strcmp(name, "N4N6") == 0) {
    value = N4N6_LINE;
  } else if (strcmp(name, "N4N7") == 0) {
    value = N4N7_LINE;
  } else if (strcmp(name, "N4O1") == 0) {
    value = N4O1_LINE;
  } else if (strcmp(name, "N4O2") == 0) {
    value = N4O2_LINE;
  } else if (strcmp(name, "N4O3") == 0) {
    value = N4O3_LINE;
  } else if (strcmp(name, "N4O4") == 0) {
    value = N4O4_LINE;
  } else if (strcmp(name, "N4O5") == 0) {
    value = N4O5_LINE;
  } else if (strcmp(name, "N4O6") == 0) {
    value = N4O6_LINE;
  } else if (strcmp(name, "N4O7") == 0) {
    value = N4O7_LINE;
  } else if (strcmp(name, "N4P1") == 0) {
    value = N4P1_LINE;
  } else if (strcmp(name, "N4P2") == 0) {
    value = N4P2_LINE;
  } else if (strcmp(name, "N4P3") == 0) {
    value = N4P3_LINE;
  } else if (strcmp(name, "N4P4") == 0) {
    value = N4P4_LINE;
  } else if (strcmp(name, "N4P5") == 0) {
    value = N4P5_LINE;
  } else if (strcmp(name, "N5N6") == 0) {
    value = N5N6_LINE;
  } else if (strcmp(name, "N5N7") == 0) {
    value = N5N7_LINE;
  } else if (strcmp(name, "N5O1") == 0) {
    value = N5O1_LINE;
  } else if (strcmp(name, "N5O2") == 0) {
    value = N5O2_LINE;
  } else if (strcmp(name, "N5O3") == 0) {
    value = N5O3_LINE;
  } else if (strcmp(name, "N5O4") == 0) {
    value = N5O4_LINE;
  } else if (strcmp(name, "N5O5") == 0) {
    value = N5O5_LINE;
  } else if (strcmp(name, "N5O6") == 0) {
    value = N5O6_LINE;
  } else if (strcmp(name, "N5O7") == 0) {
    value = N5O7_LINE;
  } else if (strcmp(name, "N5P1") == 0) {
    value = N5P1_LINE;
  } else if (strcmp(name, "N5P2") == 0) {
    value = N5P2_LINE;
  } else if (strcmp(name, "N5P3") == 0) {
    value = N5P3_LINE;
  } else if (strcmp(name, "N5P4") == 0) {
    value = N5P4_LINE;
  } else if (strcmp(name, "N5P5") == 0) {
    value = N5P5_LINE;
  } else if (strcmp(name, "N6N7") == 0) {
    value = N6N7_LINE;
  } else if (strcmp(name, "N6O1") == 0) {
    value = N6O1_LINE;
  } else if (strcmp(name, "N6O2") == 0) {
    value = N6O2_LINE;
  } else if (strcmp(name, "N6O3") == 0) {
    value = N6O3_LINE;
  } else if (strcmp(name, "N6O4") == 0) {
    value = N6O4_LINE;
  } else if (strcmp(name, "N6O5") == 0) {
    value = N6O5_LINE;
  } else if (strcmp(name, "N6O6") == 0) {
    value = N6O6_LINE;
  } else if (strcmp(name, "N6O7") == 0) {
    value = N6O7_LINE;
  } else if (strcmp(name, "N6P1") == 0) {
    value = N6P1_LINE;
  } else if (strcmp(name, "N6P2") == 0) {
    value = N6P2_LINE;
  } else if (strcmp(name, "N6P3") == 0) {
    value = N6P3_LINE;
  } else if (strcmp(name, "N6P4") == 0) {
    value = N6P4_LINE;
  } else if (strcmp(name, "N6P5") == 0) {
    value = N6P5_LINE;
  } else if (strcmp(name, "N7O1") == 0) {
    value = N7O1_LINE;
  } else if (strcmp(name, "N7O2") == 0) {
    value = N7O2_LINE;
  } else if (strcmp(name, "N7O3") == 0) {
    value = N7O3_LINE;
  } else if (strcmp(name, "N7O4") == 0) {
    value = N7O4_LINE;
  } else if (strcmp(name, "N7O5") == 0) {
    value = N7O5_LINE;
  } else if (strcmp(name, "N7O6") == 0) {
    value = N7O6_LINE;
  } else if (strcmp(name, "N7O7") == 0) {
    value = N7O7_LINE;
  } else if (strcmp(name, "N7P1") == 0) {
    value = N7P1_LINE;
  } else if (strcmp(name, "N7P2") == 0) {
    value = N7P2_LINE;
  } else if (strcmp(name, "N7P3") == 0) {
    value = N7P3_LINE;
  } else if (strcmp(name, "N7P4") == 0) {
    value = N7P4_LINE;
  } else if (strcmp(name, "N7P5") == 0) {
    value = N7P5_LINE;
  } else {
    value = -999;
  }
...
int getXRFCS(int mode) {
  ...
  if (cosThetaIn < 1.0E-6) {
    printf("Incident angle too close to target surface. thetaIn = %f (deg)\n", thetaIn);
  }
  if (cosThetaOut < 1.0E-6) {
    printf("Outgoing angle too close to target surface. thetaOut = %f (deg)\n", thetaOut);
  }
  ...
  if (verbose > 3) {
    printf("getXRFCS: trace-Z = %d, targetMassThickness = %f\n", Z, targetMassThickness);
  }
  if (verbose > 2) {
    ...
    if (mode == 2 || mode == 12) {
      printf("   xrfFluxDensity");
    }
    if (mode == 3 || mode == 4 || mode == 13 || mode == 14) {
      printf("     xrfFluxFactor  xrfPowerFactor");
    }
    printf("\n             (eV)        (cm^2/g)     (cm^2/g)");
    if (mode == 2 || mode == 12) {
      printf("     (1/sterad)");
  ...
  for (i = 0; i < npts; i++) {
    ...
    if (verbose > 2) {
      ...
      if (mode == 1 || mode == 11) {
        printf("%12.4f", totalXRFYield[i]);
      } else if (mode == 2 || mode == 12) {
        printf("%16.4g", xrfFluxDensity[i]);
      } else if (mode == 3 || mode == 4 || mode == 13 || mode == 14) {
        printf("%16.4g, %14.4g", xrfFluxFactor[i], xrfPowerFactor[i]);
      }
    }
  }
